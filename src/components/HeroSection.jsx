				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-2 items-center">
					...
					<div className="text-left space-y-6">
						...
						<h1 className="text-4xl md:text-6xl font-bold tracking-tight leading-[1.1]">
							<span className="animate-fade-in">Hi, I&apos;m</span> <span className="text-[hsl(var(--primary))] animate-fade-in-delay-1">Abdul</span> <span className="text-gradient animate-fade-in-delay-2">Gany</span>
						</h1>

						<p className="text-lg md:text-xl opacity-80 max-w-xl animate-fade-in-delay-3">Front-End Developer who focuses on neat, responsive UI, and clear user experience.</p>
						...
						<div className="flex flex-wrap gap-3 pt-2 animate-fade-in-delay-4">
							...
							<div className="flex items-center gap-2 ml-0 sm:ml-2">
								<a
									href="https://www.linkedin.com/in/abdul-gany-baehaqi/"
									target="_blank"
									rel="noopener noreferrer"
									className="p-2 rounded-full border hover:bg-[hsl(var(--secondary))]/60 transition-colors"
									aria-label="LinkedIn"
								>
									<Linkedin size={18} />
								</a>
								...
								<a
									href="https://www.instagram.com/abdulgany_/"
									target="_blank"
									rel="noopener noreferrer"
									className="p-2 rounded-full border hover:bg-[hsl(var(--secondary))]/60 transition-colors"
						...
						<div className="pt-2 text-sm opacity-70">Based in Batu, Jawa Timur • Available Remote/Onsite</div>
					</div>
